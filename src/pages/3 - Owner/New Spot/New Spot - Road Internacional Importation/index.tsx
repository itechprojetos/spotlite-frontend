...
const NewSpot: React.FC = () => {
  ...
  const handleRoadLoadType = useCallback(async (event: ChangeEvent<HTMLSelectElement>) => {
  ...
  const handleIncoterm = useCallback(async (event: ChangeEvent<HTMLSelectElement>) => {
    ...
    // if (importation) {
    if (data === 'EXW' || data === 'FCA' || data === 'FAS') {
      // setIncoterm(true);

      setYyy(true);
      setNyy(false);
    } else if (data === 'FOB' || data === 'CFR' || data === 'CIF' || data === 'CPT' || data === 'CIP' || data === 'DAP' || data === 'DPU' || data === 'DDP') {
      // setIncoterm(true);
        ...
        <Content>
          ...
          <ContainerHeaderSpecifications>
            ...
            <ItemsContainer>
              ...
              <SpotPickup>Rodoviário</SpotPickup>
              <SpotDelivery>Importação</SpotDelivery>
            </ItemsContainer>
          </ContainerHeaderSpecifications>
          ...
          <Form ref={formRef} onSubmit={handleSubmit}>
              ...
              <InputContainer>
                ...
                <SelectContainer>
                  ...
                  >
                    ...
                    {optionsRoadLoadType.map((option) => (
            ...
            {roadFull ? (
              <TwoInputsTextField label="Cidade de cruzamento" variant="outlined" size="small" onChange={(event) => setCruzeCity(event.target.value)} />
            ...
            {incotermOpened && (yyy ? (
              <>
                ...
                >
                  <TwoInputsTextField label="Estação de origem" variant="outlined" size="small" onChange={(event) => setPlaceOrigin(event.target.value)} />
                  <TwoInputsTextField label="Estação de destino" variant="outlined" size="small" onChange={(event) => setPlaceDestination(event.target.value)} />
                </DivFlex>
            ...
            >
              <TwoInputsTextField label="Temperatura mínima (ºC)" variant="outlined" size="small" onChange={(event) => setTempMin(event.target.value)} />
              <TwoInputsTextField label="Temperatura máxima (ºC)" variant="outlined" size="small" onChange={(event) => setTempMax(event.target.value)} />
            </DivFlex>
